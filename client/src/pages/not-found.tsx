...
export default function NotFound() {
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-white-secondary p-4">
      <Card className="w-full max-w-md border border-black-10 shadow-sm bg-white">
        <CardContent className="pt-6 text-center">
          <div className="flex justify-center mb-4">
            <div className="h-16 w-16 rounded-full bg-black-5 flex items-center justify-center border border-black-10">
              <AlertCircle className="h-8 w-8 text-orange" />
            </div>
          </div>
          <h1 className="font-display text-3xl font-bold text-black mb-2">404</h1>
          <h2 className="font-display text-xl font-semibold text-black-80 mb-4">Page Not Found</h2>
